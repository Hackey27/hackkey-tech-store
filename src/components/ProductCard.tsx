    ...
    >
      ...
      <div className="px-5 sm:px-6 py-4 bg-[#f8fbfa] border-t border-[#e2ecea] flex items-center justify-between gap-3">
        ...
        {product.kind !== 'laptop' && <div>
          ...
          {(product.promoLabel || product.promoPercent) && <span className="mt-1 block text-[10px] font-black text-[#0d6520]">{product.promoLabel || `${product.promoPercent}% off`} · <PromotionCountdown endsAt={product.promoEndsAt} /></span>}
        </div>}
