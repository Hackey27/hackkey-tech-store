...
import type { PublicPaymentOptions } from '../types';
...
export function DirectCheckoutModal({ item, paymentOptions, onClose }: { item: CartItem; paymentOptions?: PublicPaymentOptions; onClose: () => void }) {
