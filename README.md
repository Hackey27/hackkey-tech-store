...
┌─────────────────────────────────────────────────────────────┐
│                    React + TypeScript UI                    │
│   (Archivo + Maven Pro, Dark Green #014040, Bright #05ef28) │
...
- **Typography**: Google Font **Maven Pro** for titles (`font-heading`); **Archivo** for prices and other details (`font-sans`)
